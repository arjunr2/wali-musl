...
#define a_cas a_cas
int a_cas(volatile int *p, int t, int s) __attribute((
  __import_name__("a_cas")
));
...
void a_crash()
__attribute((
  __import_name__("a_crash")
));

#define a_ctz_64 a_ctz_64
int a_ctz_64(uint64_t x)
__attribute((
  __import_name__("a_ctz_64")
));

#define a_clz_64 a_clz_64
int a_clz_64(uint64_t x)
__attribute((
  __import_name__("a_clz_64")
));
