...
static long __syscall_var(long n, long a1, long a2, long a3, long a4, long a5, long a6) {
  switch(n) {
		...
		CASE_SYSCALL (pread64, pread64, (int)a1,(char*)a2,(unsigned int)a3,(long long)a4);
		CASE_SYSCALL (pwrite64, pwrite64, (int)a1,(char*)a2,(unsigned int)a3,(long long)a4);
		...
		CASE_SYSCALL (sendto, sendto, (int)a1,(void*)a2,(unsigned int)a3,(int)a4,(void*)a5,(unsigned int)a6);
		...
		CASE_SYSCALL (readlinkat, readlinkat, (int)a1,(char*)a2,(char*)a3,(unsigned int)a4);
		CASE_SYSCALL (fchmodat, fchmodat, (int)a1,(char*)a2,(int)a3,(int)a4);
		...
		CASE_SYSCALL (renameat2, renameat2, (int)a1,(char*)a2,(int)a3,(char*)a4,(int)a5);
