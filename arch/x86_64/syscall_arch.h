...
static long __syscall_var(long n, long a1, long a2, long a3, long a4, long a5, long a6) {
  switch(n) {
		...
		CASE_SYSCALL (pread64, pread64, (int)a1,(void*)a2,(long)a3,(long long)a4);
		CASE_SYSCALL (pwrite64, pwrite64, (int)a1,(void*)a2,(long)a3,(long long)a4);
		...
		CASE_SYSCALL (fadvise64, fadvise, (int)a1,(long long)a2,(long long)a3,(int)a4);
